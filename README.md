...
- [ ] Explain what a token is used for.
  ...
  A token is used for client side authentication so that protected information is only displayed to a specified user. 

- [ ] What steps can you take in your web apps to keep your data secure?

  You can use private routes, redirects and client side authentication.

- [ ] Describe how web servers work.

  A web server is connected to the internet and stores the code for the different websites to be shared across the world at all times. It serves web pages it retrieves from your project code to users upon request

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

C is create is for post, R is for read is for get, U is for update which is for put/patch, and D is for delete which is delete.
